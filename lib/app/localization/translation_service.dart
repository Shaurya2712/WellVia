...
class TranslationService extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'en_US': {
      ...
      "home_search": "Search",
      "home_search_placeholder": "Search for doctors, tests, packages...",
      ...
      // Lab Reports Section
      "home_lab_reports": "Lab Reports",
      "Add to Cart": "Add To Cart",
      "Add To Cart": "Add To Cart",
      "View Details": "View Details",

      // Recommended Packages Section
      "home_recommended_packages": "Recommended Packages",
      "Book Now": "Book Now",

      // Health Conditions Section
      "home_health_conditions": "Tests For Health Conditions",
      "Available Tests": "Available Tests",
      "Diabetes": "Diabetes",
      "Hypertension": "Hypertension",
      "Malaria": "Malaria",
      "Dengue": "Dengue",
      "Lipid Profile Tests - Comprehensive": "Lipid Profile Tests - Comprehensive",
      "Includes 15 Tests": "Includes 15 Tests",
      "HbA1c Test": "HbA1c Test",
      "Includes 1 Test": "Includes 1 Test",
      "Kidney Function Test": "Kidney Function Test",
      "Includes 10 Tests": "Includes 10 Tests",
      "Malaria Antigen Test": "Malaria Antigen Test",
      "Dengue NS1 Antigen": "Dengue NS1 Antigen",
      "Comprehensive lipid profile for diabetes management.": "Comprehensive lipid profile for diabetes management.",
      "Glycated hemoglobin for long-term glucose control.": "Glycated hemoglobin for long-term glucose control.",
      "Assess kidney health for hypertension.": "Assess kidney health for hypertension.",
      "Detects malaria antigens in blood.": "Detects malaria antigens in blood.",
      "Early detection of dengue infection.": "Early detection of dengue infection.",
      "70% OFF": "70% OFF",
      "20% OFF": "20% OFF",
      "50% OFF": "50% OFF",
      "10% OFF": "10% OFF",
